import{d,u as p,a as _,c as m,b as u,r as h,e as n,f as t,t as a,g as r,F as f,h as g,n as v,i as x,o as l,j as y,k as b,l as N,m as k,_ as P}from"./index-FL6AWuHR.js";import{N as w}from"./NoteDisplay-qqCzb2lb.js";const V={class:"m-4"},D={class:"mb-10"},L={class:"text-4xl font-bold mt-2"},S={class:"opacity-50"},T={class:"text-lg"},B={class:"font-bold flex gap-2"},C={class:"opacity-50"},H={key:0,class:"border-gray-400/50 mb-8"},j=d({__name:"PresenterPrint",setup(z){p(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
