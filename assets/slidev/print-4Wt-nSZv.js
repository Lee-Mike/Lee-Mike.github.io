import{d as _,a4 as u,z as h,f as n,g as t,t as s,S as c,F as f,aj as g,o as l,i as v,e as x,ad as b}from"../modules/vue-C1lp3Ci0.js";import{a as y,u as N,x as m}from"../index-d7PUQqOg.js";import{_ as k}from"./NoteDisplay.vue_vue_type_style_index_0_lang-Dz8GepQV.js";import"../modules/shiki-DHNGtW2h.js";const w={id:"page-root"},L={class:"m-4"},S={class:"mb-10"},T={class:"text-4xl font-bold mt-2"},V={class:"opacity-50"},B={class:"text-lg"},H={class:"font-bold flex gap-2"},j={class:"opacity-50"},z={key:0,class:"border-main mb-8"},A=_({__name:"print",setup(C){const{slides:d,total:p}=y();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
